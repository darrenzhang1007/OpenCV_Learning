...
String model_bin = "F:/opencv_tutorial/data/models/face_detector/opencv_face_detector_uint8.pb";
String config_text = "F:/opencv_tutorial/data/models/face_detector/opencv_face_detector.pbtxt";

int main(int argc, char** argv) {
	Mat frame = imread("H:/OpenCV_Learning/126_DNN_Face_Detector/test.jpg");
	if (frame.empty()) {
