...
yolo_tiny_model = "E:/models/YOLO/yolov3-tiny-coco/yolov3-tiny.weights"
yolo_tiny_cfg = "E:/models/YOLO/yolov3-tiny-coco/yolov3-tiny.cfg"

# Load names of classes
classes = None
with open("E:/models/YOLO/object_detection_classes_yolov3.txt", 'rt') as f:
...
vw_out = cv.VideoWriter("clip_one.mp4", cv.VideoWriter_fourcc('D', 'I', 'V', 'X'), 10, (np.int(width), np.int(height)), True)
index = 0
while True:
    ret, image = cap.read()
    if ret is False:
