...
int main(int argc, char** argv) {
	Mat src1 = imread("H:\\OpenCV_Learning\\019_CompareHist\\test1.jpg");
	Mat src2 = imread("H:\\OpenCV_Learning\\019_CompareHist\\test2.jpg");
	Mat src3 = imread("H:\\OpenCV_Learning\\019_CompareHist\\test3.png");
	Mat src4 = imread("H:\\OpenCV_Learning\\019_CompareHist\\test4.png");
	...
	calcHist(&hsv1, 1, channels, Mat(), hist1, 2, histSize, ranges, true, false); //  1:数组中只有一张图片， MASK:mat对象
