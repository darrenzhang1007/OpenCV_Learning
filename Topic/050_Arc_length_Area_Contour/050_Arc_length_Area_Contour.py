...
def canny_demo(image):
    t = 80
    canny_out = cv.Canny(image, t, t*2)
    cv.imshow("canny_output", canny_out)
    cv.imwrite("canny_output.png", canny_out)
    return canny_out


src = cv.imread("H:/OpenCV_Learning/050_Arc_length_Area_Contour/test.png")
