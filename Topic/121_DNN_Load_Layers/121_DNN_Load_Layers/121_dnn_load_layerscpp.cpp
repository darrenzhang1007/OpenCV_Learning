...
int main(int argc, char** argv) {
	string bin_model = "H:/OpenCV_Learning/121_DNN_Load_Layers/googlenet/bvlc_googlenet.caffemodel";
	string protxt = "H:/OpenCV_Learning/121_DNN_Load_Layers/googlenet/bvlc_googlenet.prototxt";
