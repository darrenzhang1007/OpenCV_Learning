...
String labels_txt_file = "H:/OpenCV_Learning/122_DNN_Classification/inception5h/imagenet_comp_graph_label_strings.txt";
String tf_pb_file = "H:/OpenCV_Learning/122_DNN_Classification/inception5h/tensorflow_inception_graph.pb";
vector<String> readClassNames();
int main(int argc, char** argv) {
	Mat src = imread("H:/OpenCV_Learning/122_DNN_Classification/space_shuttle.jpg");
	if (src.empty()) {
