...
string label_map = "E:/models/tf_models/faster_rcnn_resnet50_coco_2018_01_28/mscoco_label_map.pbtxt";
string model = "E:/models/tf_models/faster_rcnn_resnet50_coco_2018_01_28/frozen_inference_graph.pb";
string config = "E:/models/tf_models/faster_rcnn_resnet50_coco_2018_01_28/graph.pbtxt";

std::map<int, String> readLabelMaps();
int main(int argc, char** argv) {
	Mat src = imread("H:/OpenCV_Learning/124_SSD_Image/dog.jpg");
	int width = src.cols;
	int height = src.rows;
	if (src.empty()) {
